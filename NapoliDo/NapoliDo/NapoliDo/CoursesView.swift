...
struct CoursesView: View {
    ...
    var body: some View {
        ...
        NavigationStack{
            List{
                ...
                ForEach(listaBottone.filter({list in list.categoria == "corso"})) { bottone in
    ...
    struct CoursesView_Previews: PreviewProvider {
        static var previews: some View {
            CoursesView(textsearch: "", listaBottone: .constant([Bottone(id:0, titoloBottone:"Anti-war Gathering", sottotitoloBottone: "25/10/2022", fotoBottone: "Evento1", descrizione: "descrizione", telefono: "telefono", sito:"sito", mail:"mail", isPref: false, categoria: "evento")]))
        }
    }
}
